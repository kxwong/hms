    ...
    <style>
        <%
            ...
            for (int j = 0; j < roomList.size(); j++) {
                if (!roomList.get(j).getRoomNo().equals(room.getRoomNo())) {
                    Room tempoRoom = roomList.get(j);
                    Roommapping roomMapping = tempoRoom.First();
                    String assignedCoor = "";
                    String xCoor = "";
                    String yCoor = "";
                    do {
        ...
        %>
        #canvasDiv > div:nth-child(<%=divSerial%>) {
        ...
        <div class="content">
            ...
            <div class="cBody">
                <div class="cbContent">
                    ...
                    <form action="/updateRoomMapping" method="post">
                        ...
                        <input type="submit" value="Done" class="cbAdd cBAddright">
                    </form>
                </div>
            </div>
        </div>
