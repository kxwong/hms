...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../../managementSide/source/css/authorizeAccount.css">
    ...
    <body>
        ...
        <div class="content">
            <div class="cHeader">
                <div class="chTitle">Authorize Account</div>
            </div>
            <div class="cBody">
                <div class="cbContent">
                    <form action="/storeAccount" method="post">
                        <table>
                            <tr>
                                <td><div class="cbLabel">Position</div></td>
                                <td> : </td>
                                <td>
                                    <select name="level" class="cbInput">
                                        <option>Admin</option>
                                        <option>Guard</option>
                                    </select>
                                </td>
                            ...
                            <tr>
                                <td><div class="cbLabel">New Username</div></td>
                                <td> : </td>
                                <td><input  class="cbInput" name="username" type="text" minlength="6" required=""></td>
                            </tr>
                            <tr>
                                <td><div class="cbLabel">Password</div></td>
                                <td> : </td>
