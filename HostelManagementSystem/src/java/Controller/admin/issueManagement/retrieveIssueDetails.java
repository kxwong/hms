...
public class retrieveIssueDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (issueManager.findIssueByID(caseNo) != null) {
                session.setAttribute("issue", issueManager.findIssueByID(caseNo));
                response.sendRedirect("/admin/issue/viewIssue");
            } else {
                throw new Exception("Selected case issue is not existed");
            }
        } catch (Exception ex) {
