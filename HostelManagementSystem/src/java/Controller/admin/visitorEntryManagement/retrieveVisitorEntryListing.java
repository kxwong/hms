...
public class retrieveVisitorEntryListing extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch (term) {
                case 1:
                    searchingCriteria = new EntryRecordSearchingCriteria("0", "V", "", "", "", "", getInitStartDate(entryRecordManager), getInitEndDate(entryRecordManager), "Entry", "e.entRecordID", "ASC");
                    String gate;
                    try {
                    ...
                    session.setAttribute("visitorEntryRecordList", entryRecordManager.findAllWithParameter(searchingCriteria.getEntHolder(), searchingCriteria.getEntID(), searchingCriteria.getTenantName(),
                    ...
                    response.sendRedirect("/admin/entry/visitorEntryListing");
                    break;
                case 2:
            ...
            session.setAttribute("vsearchingCriteria", new EntryRecordSearchingCriteria("0", "V", "", "","", "", getInitStartDate(entryRecordManager), getInitEndDate(entryRecordManager), "Entry", "e.entRecordID", "ASC"));
            session.setAttribute("visitorEntryRecordList", entryRecordManager.findAllWithParameter("V", "", "","", "", getInitStartDate(entryRecordManager), getInitEndDate(entryRecordManager), "Entry", "e.entRecordID", "ASC"));
            response.sendRedirect("/admin/entry/visitorEntryListing");
        }
    }
